...
@docs rose_950
@docs primary
@docs primary_content
@docs secondary
@docs secondary_content
@docs accent
@docs accent_content
@docs neutral_content
@docs base_100
@docs base_200
@docs base_300
@docs base_content
...
@docs info_content
@docs success
@docs success_content
@docs warning
@docs warning_content
@docs error
@docs error_content
@docs neutral_50
@docs neutral_100
...
neutral : Color
neutral =
    Tw.Keyword "var(--fallback-n,oklch(var(--n)/1))"
...
primary : Color
primary =
    Tw.Keyword "var(--fallback-p,oklch(var(--p)/1))"


primary_content : Color
primary_content =
    Tw.Keyword "var(--fallback-pc,oklch(var(--pc)/1))"


secondary : Color
secondary =
    Tw.Keyword "var(--fallback-s,oklch(var(--s)/1))"


secondary_content : Color
secondary_content =
    Tw.Keyword "var(--fallback-sc,oklch(var(--sc)/1))"


accent : Color
accent =
    Tw.Keyword "var(--fallback-a,oklch(var(--a)/1))"


accent_content : Color
accent_content =
    Tw.Keyword "var(--fallback-ac,oklch(var(--ac)/1))"


neutral_content : Color
neutral_content =
    Tw.Keyword "var(--fallback-nc,oklch(var(--nc)/1))"


base_100 : Color
base_100 =
    Tw.Keyword "var(--fallback-b1,oklch(var(--b1)/1))"


base_200 : Color
base_200 =
    Tw.Keyword "var(--fallback-b2,oklch(var(--b2)/1))"


base_300 : Color
base_300 =
    Tw.Keyword "var(--fallback-b3,oklch(var(--b3)/1))"


base_content : Color
base_content =
    Tw.Keyword "var(--fallback-bc,oklch(var(--bc)/1))"


info : Color
info =
    Tw.Keyword "var(--fallback-in,oklch(var(--in)/1))"


info_content : Color
info_content =
    Tw.Keyword "var(--fallback-inc,oklch(var(--inc)/1))"


success : Color
success =
    Tw.Keyword "var(--fallback-su,oklch(var(--su)/1))"


success_content : Color
success_content =
    Tw.Keyword "var(--fallback-suc,oklch(var(--suc)/1))"


warning : Color
warning =
    Tw.Keyword "var(--fallback-wa,oklch(var(--wa)/1))"


warning_content : Color
warning_content =
    Tw.Keyword "var(--fallback-wac,oklch(var(--wac)/1))"


error : Color
error =
    Tw.Keyword "var(--fallback-er,oklch(var(--er)/1))"


error_content : Color
error_content =
    Tw.Keyword "var(--fallback-erc,oklch(var(--erc)/1))"
